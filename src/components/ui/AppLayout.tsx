...
{notifs.length > 0 ? <IconBellDot size={22} color="rgba(255,255,255,0.8)" /> : <IconBell size={22} color="rgba(255,255,255,0.8)" />}
              ...
              {notifOpen && (
                <div style={{ position: 'fixed', top: 56, right: 12, width: 'min(320px, calc(100vw - 24px))', background: '#0d0f14', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 16, boxShadow: '0 16px 48px rgba(0,0,0,0.6)', zIndex: 600, overflow: 'hidden', display: 'flex', flexDirection: 'column', maxHeight: 'calc(100vh - 72px)', height: 'calc(100vh - 72px)' }}
