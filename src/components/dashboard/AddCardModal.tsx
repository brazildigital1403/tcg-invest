              ...
              {!preview ? (
                ...
                <div style={{ padding: isMobile ? 12 : 16 }}>
                  ...
                  <div style={{ marginBottom: 12 }}>
                    <p style={{ fontSize: 10, color: TEXT_MUTED, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 6 }}>Condição</p>
                    ...
                    {isPro ? (
                        ...
                        {splitOn[preview.id] && (
                          <div style={{ marginTop: 8, display: 'flex', flexDirection: 'column', gap: 6, background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(245,158,11,0.2)', borderRadius: 10, padding: 10 }}>
                            ...
                            <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: 6, display: 'flex', justifyContent: 'space-between', fontSize: 11 }}>
                              ...
                              <span style={{ color: '#f59e0b', fontWeight: 700 }}>{splitTotal(preview.id)} cópia{splitTotal(preview.id) !== 1 ? 's' : ''}</span>
                            </div>
                          </div>
                        )}
                      </>
                      ...
                      <button onClick={() => { window.location.href = '/minha-conta' }}
                        style={{ marginTop: 8, fontSize: 11, color: 'rgba(255,255,255,0.55)', background: 'rgba(245,158,11,0.06)', border: '1px solid rgba(245,158,11,0.18)', borderRadius: 8, padding: '8px 10px', cursor: 'pointer', fontFamily: 'inherit', display: 'flex', alignItems: 'flex-start', gap: 7, textAlign: 'left', width: '100%', lineHeight: 1.4 }}>
                        <svg width="13" height="13" viewBox="0 0 20 20" fill="none" style={{ flexShrink: 0, marginTop: 1 }}><rect x="4" y="9" width="12" height="8" rx="1.5" stroke="#f59e0b" strokeWidth="1.4"/><path d="M7 9V6.5a3 3 0 016 0V9" stroke="#f59e0b" strokeWidth="1.4"/></svg>
