...
const S: Record<string, CSSProperties> = {
  ...
  nota: { fontSize: 12, color: '#f59e0b', margin: '6px 0 0' },
  ...
  btnPrimary: { background: 'linear-gradient(135deg, #f59e0b, #ef4444)', border: 'none', color: '#000', padding: '10px 18px', borderRadius: 10, fontSize: 13, fontWeight: 800, cursor: 'pointer', fontFamily: 'inherit', flexShrink: 0 },
