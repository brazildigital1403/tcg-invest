          ...
          <div className="sp-hero-inner" style={S.heroInner}>
            <div style={S.heroLeft}>
              ...
              <div className="sp-hero-ctas" style={S.heroCtas}>
                <Link href="/separadores-pokemon?auth=signup&next=/separadores" style={S.ctaPrimary}>
        ...
        <section className="sp-section" style={S.sectionDark}>
          <div className="bx-gutter" style={S.container}>
            <div style={S.priceCard}>
              ...
              <Link href="/separadores-pokemon?auth=signup&next=/separadores" style={S.priceCta}>
                Comprar agora — R$ 14,90
              </Link>
            </div>
          </div>
