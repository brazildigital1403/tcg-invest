 ...
 *
 * ★ CACHE (rota dinamica cai na armadilha de 29/07 se nao configurar):
 * sem generateStaticParams o Next trata a rota como on-demand e renderiza a
 * cada request, igual a page. Lista vazia = nada no build, cada set
 * compartilhado vira ISR de 7 dias. Nome, logo e cartas de destaque de um set
 * quase nunca mudam; redeploy fura o cache se precisar.
 *
