...
const IcChevL = () => (<svg className="ico" viewBox="0 0 24 24"><path d="M15 6l-6 6 6 6" /></svg>)
      ...
      <main className="hmmain">
              ...
              <div className="stage">
                ...
                <div className="appmock">
                  ...
                  <div className="am-patr">
                    ...
                    <div className="am-ptrend"><IcUp /> <span id="hm-trend">R$ 842 este mês &middot; +7,2%</span></div>
                  </div>
        ...
        <section className="final">
          ...
          <div className="cardmodal" id="hm-cardmodal" aria-hidden="true">
            ...
            <button className="cm-nav cm-prev" id="hm-cmprev" type="button" aria-label="Carta anterior"><IcChevL /></button>
            <div className="cm-inner">
              <button className="cm-close" data-close type="button" aria-label="Fechar"><IcClose /></button>
              <img id="hm-cmimg" alt="Carta ampliada" />
              <div className="cm-count" id="hm-cmcount" />
            </div>
            <button className="cm-nav cm-next" id="hm-cmnext" type="button" aria-label="Proxima carta"><IcChevR /></button>
          </div>
        </section>
      </main>
...
.hmmain{
  ...
  .track .mq{cursor:pointer}.hm-root .cardmodal{position:fixed;inset:0;z-index:100;display:none;align-items:center;justify-content:center;gap:12px;padding:24px}.hm-root .cardmodal.open{display:flex}.hm-root .cm-backdrop{position:absolute;inset:0;background:rgba(4,6,10,.84);backdrop-filter:blur(6px);animation:hmcmfade .2s ease}@keyframes hmcmfade{from{opacity:0}to{opacity:1}}.hm-root .cm-inner{position:relative;z-index:1;animation:hmcmpop .25s cubic-bezier(.22,.61,.36,1)}@keyframes hmcmpop{from{opacity:0;transform:scale(.9)}to{opacity:1;transform:none}}.hm-root .cm-inner img{max-width:min(76vw,390px);max-height:86vh;border-radius:16px;box-shadow:0 40px 120px rgba(0,0,0,.75);display:block}.hm-root .cm-close{position:absolute;top:-14px;right:-14px;width:38px;height:38px;border-radius:50%;background:var(--card);border:1px solid var(--border-2);color:var(--text);display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 8px 24px rgba(0,0,0,.5)}.hm-root .cm-close .ico{width:18px;height:18px;stroke-width:2.4}.hm-root .cm-inner{display:flex;flex-direction:column;align-items:center;gap:12px;flex:0 1 auto;min-width:0}.hm-root .cm-count{font-size:13px;font-weight:700;color:#fff;background:rgba(0,0,0,.45);border:1px solid rgba(255,255,255,.16);padding:5px 14px;border-radius:999px;font-variant-numeric:tabular-nums}.hm-root .cm-nav{position:relative;z-index:5;flex:0 0 auto;width:48px;height:48px;border-radius:50%;background:var(--card);border:1px solid var(--border-2);color:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 10px 28px rgba(0,0,0,.55);transition:transform .15s ease,background .15s ease}.hm-root .cm-nav:hover{transform:scale(1.1);background:var(--surface-2)}.hm-root .cm-nav .ico{width:24px;height:24px;stroke-width:2.6}@media(max-width:600px){.hm-root .cm-nav{width:40px;height:40px}.hm-root .cm-nav .ico{width:20px;height:20px}.hm-root .cm-inner img{max-width:62vw}}@media(prefers-reduced-motion:reduce){.hm-root *{animation:none!important}.hm-root .reveal{opacity:1;transform:none;transition:none}}`
