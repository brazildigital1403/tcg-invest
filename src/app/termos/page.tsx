    ...
    <div style={{ background: '#080a0f', minHeight: '100vh', fontFamily: "'DM Sans', system-ui, sans-serif", color: '#f0f0f0' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '60px 24px 100px' }}>
        ...
        <Section title="4. Planos e Pagamentos (Colecionadores)">
          ...
          <P><strong style={{ color: '#f59e0b' }}>Plano Pro Mensal:</strong> R$ 29,90 (vinte e nove reais e noventa centavos) por mês, com renovação automática. Libera funcionalidades ilimitadas, incluindo cartas e anúncios sem limite, scan com IA (100 créditos mensais), histórico completo de preços e dashboard avançado.</P>
          <P><strong style={{ color: '#f59e0b' }}>Plano Pro Anual:</strong> R$ 249,00 (duzentos e quarenta e nove reais) por ano, equivalente a um desconto significativo sobre o valor mensal. Mesma cobertura do Pro Mensal, com scan com IA ilimitado e Master Sets liberados.</P>
