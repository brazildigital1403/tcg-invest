    ...
    <div style={{ background: '#080a0f', minHeight: '100vh', fontFamily: "'DM Sans', system-ui, sans-serif", color: '#f0f0f0' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '60px 24px 100px' }}>
        ...
        <Section title="4. Planos e Pagamentos (Colecionadores)">
          ...
          <P><strong style={{ color: '#f59e0b' }}>Plano Plus:</strong> R$ 14,90 (quatorze reais e noventa centavos) por mês, com renovação automática. Permite o cadastro de até 500 (quinhentas) cartas, anúncios ilimitados no Marketplace, dashboard financeiro, Pokédex completa e scan com IA limitado a 100 (cem) leituras por mês.</P>
